    ...
    return (
        <nav class="w-full flex items-center justify-between h-[80px] px-8">
            ...
            <ul class="flex items-center px-4 gap-x-2 h-[60px] rounded-md bg-[#333333]/10 backdrop-blur-md border border-white/20 shadow-lg">
                <For each={NAV_ITEMS}>
                    {(item) => (
                        <li class="cursor-pointer px-4 py-2 rounded-lg brand-gradient bg-[#333333] text-white/90">
                            {item}
                        </li>
                    )}
                </For>
            ...
            <a href="#contact" class="flex items-center brand-gradient px-6 h-[60px] rounded-xl text-white">
                Get in touch
            </a>
        </nav>
    );
